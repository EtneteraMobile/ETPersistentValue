...
open class PersistentSet<Element: Hashable>: BoxedPersistentValue<Set<Element>> {
    ...
    public init(key: CustomStringConvertible, userDefaults: UserDefaults = UserDefaults.standard) {
        super.init(PersistentUserDefaultsValue<ValueType>(key: key, userDefaults: userDefaults, convertFrom: PersistentSet.fromUserDefaults, convertTo: PersistentSet.toUserDefaults))
    }
    ...
    public init(key: CustomStringConvertible, value: ValueType, userDefaults: UserDefaults = UserDefaults.standard) {
        super.init(PersistentUserDefaultsValue<ValueType>(key: key, value: value, userDefaults: userDefaults, convertFrom: PersistentSet.fromUserDefaults, convertTo: PersistentSet.toUserDefaults))
    }
